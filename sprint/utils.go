...
func IsVerbose(parent glue.Container) (verbose bool) {
	...
	list := parent.Bean(ApplicationFlagsClass, 0)
	if len(list) > 0 {
...
func DoWithClient(parent glue.Container, role string, clientType reflect.Type, cb func(clientInstance interface{}) error) error {
